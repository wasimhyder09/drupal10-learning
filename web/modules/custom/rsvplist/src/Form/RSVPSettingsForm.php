...
/**
 * @file
 * Contains the settings for administring the RSVP Form.
 */
...
class RSVPSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['rsvplist_types'] = [
      ...
      '#options' => $types,
      '#description' => $this->t('On the specified node types, an RSVP option will be available and can be enabled
      while the node is being edited'),
    ];
